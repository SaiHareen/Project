...
#grid_search = SVC(gamma='auto')#GridSearchCV(SVC(),  parameters,cv =5, n_jobs= -1)
...
performance = 3 + 10 * np.random.rand(len(names))
...
ax.set_title('Feature Relative importances')
